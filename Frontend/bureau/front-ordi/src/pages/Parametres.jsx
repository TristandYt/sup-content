    ...
    const handleDeleteAccount = async () => {
        ...
        try {
            ...
            if (err.code === "auth/requires-recent-login") {
                alert("Par mesure de sécurité, veuillez vous déconnecter puis vous reconnecter avant de supprimer votre compte.");
            } else {
    ...
    return (
        <div className="accueil-container">
            ...
            <div style={{ maxWidth: "800px", margin: "-80px auto 0", padding: "0 20px 60px" }}>
                <div className="game-card-modern" style={{ padding: "30px", cursor: "default", position: "relative" }}>
                    <h2 className="hero-title" style={{ fontSize: "1.8rem", margin: "0 0 24px 0", display: "flex", alignItems: "center", gap: "12px" }}>
                        <i className="fa-solid fa-gear" style={{ color: "#c084fc" }}></i> Paramètres du compte
                    </h2>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "30px" }}>
                        ...
                        <div>
                            <h3 className="section-title" style={{ fontSize: "1.2rem", marginBottom: "15px", borderBottom: "1px solid rgba(128,128,128,0.2)", paddingBottom: "10px" }}>
                                <i className="fa-solid fa-eye" style={{ marginRight: "8px", opacity: 0.7 }}></i> Affichage et Confidentialité
                            </h3>
                            ...
                            <div style={{ display: "flex", flexDirection: "column", gap: "15px" }}>
                                    ...
                                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "10px" }}>
                                        <div>
                                            <h4 style={{ margin: "0 0 4px 0", fontSize: "1.1rem", display: "flex", alignItems: "center", gap: "8px" }}>
                                                <i className="fa-solid fa-lock" style={{ color: "rgba(239, 68, 68, 0.8)" }}></i> Profil Privé
                                            </h4>
                                            <p style={{ margin: 0, fontSize: "0.85rem", opacity: 0.7, maxWidth: "400px", lineHeight: "1.5" }}>
                                                Si activé, seuls vos abonnés mutuels pourront voir votre bibliothèque de jeux et vos listes personnalisées.
                                            </p>
                                        </div>

                                        <div
                                            onClick={() => !loading && togglePreference("privateProfile")}
                                            style={{
                                                width: "50px",
                                                height: "28px",
                                                borderRadius: "99px",
                                                cursor: loading ? "wait" : "pointer",
                                                background: preferences.privateProfile ? "#9333ea" : "rgba(128,128,128,0.3)",
                                                position: "relative",
                                ...
                                <div style={{ background: "rgba(128,128,128,0.05)", padding: "20px", borderRadius: "12px", border: "1px solid rgba(128,128,128,0.1)" }}>
                                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "10px" }}>
                                        <div>
                                            <h4 style={{ margin: "0 0 4px 0", fontSize: "1.1rem", display: "flex", alignItems: "center", gap: "8px" }}>
                                                <i className="fa-solid fa-eye-slash" style={{ color: "rgba(245, 158, 11, 0.8)" }}></i> Afficher les jeux +18
                                            </h4>
                                            <p style={{ margin: 0, fontSize: "0.85rem", opacity: 0.7, maxWidth: "400px", lineHeight: "1.5" }}>
                                                Autoriser l'affichage de contenu réservé à un public averti dans les résultats de recherche et le catalogue.
                                            </p>
                                        </div>

                                        <div
                                            onClick={() => !loading && togglePreference("showAdultGames")}
                                            style={{
                                                width: "50px",
                                                height: "28px",
                                                borderRadius: "99px",
                                                cursor: loading ? "wait" : "pointer",
                                                background: preferences.showAdultGames ? "#9333ea" : "rgba(128,128,128,0.3)",
                                                position: "relative",
                                                transition: "background 0.3s",
                                                opacity: loading ? 0.5 : 1
                                            }}
                        ...
                        <div style={{ marginTop: "10px" }}>
                            <h3 className="section-title" style={{ fontSize: "1.2rem", marginBottom: "15px", borderBottom: "1px solid rgba(128,128,128,0.2)", paddingBottom: "10px" }}>
                                <i className="fa-solid fa-shield-halved" style={{ marginRight: "8px", opacity: 0.7 }}></i> Données et Sécurité
                            </h3>
