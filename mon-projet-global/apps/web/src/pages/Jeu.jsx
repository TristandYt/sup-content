...
const Jeu = ({
  ...
  const toggleFavorite = async () => {
    ...
    try {
      ...
      alert("Erreur lors de la mise à jour des favoris.", err);
    } finally {
      setFavLoading(false);
    }
  };
  ...
  const handleSaveReview = async () => {
    ...
    try {
      ...
      alert("Erreur lors de l'envoi de votre avis.", err);
    } finally {
  ...
  const handleSendComment = async (reviewId) => {
    ...
    try {
      ...
      alert("Erreur lors de l'envoi du commentaire.", e);
    } finally {
    ...
    <div
      ...
      style={{
        ...
        /* width:100% s'assure que la carte occupe toute la largeur du
           conteneur flex colonne sans en déborder */
        width: "100%",
